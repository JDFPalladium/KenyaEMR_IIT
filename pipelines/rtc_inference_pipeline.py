...
from src.inference import rtc_generate_inference

def run_rtc_inference_pipeline(ppk = str, sc = str, start_date = str, end_date = str):
    ...
    pred = rtc_generate_inference.rtc_gen_inference(targets, sc)
    print(pred)
    return pred
